...
png(file="./data/figure/plot4.png",   width = 480, height = 480, units = "px" )

par(mfrow = c(2,2))
plot(hpc_tb_df$datetime, hpc_tb_df$Global_active_power, type =  "l", xlab = "", ylab =  "Global Active Power")
plot(hpc_tb_df$datetime, hpc_tb_df$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(hpc_tb_df$datetime, hpc_tb_df$Global_reactive_power, type = "l", 
